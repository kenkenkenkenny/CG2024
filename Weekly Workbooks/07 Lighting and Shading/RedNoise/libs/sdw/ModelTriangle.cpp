...
ModelTriangle::ModelTriangle(const glm::vec3 &v0, const glm::vec3 &v1, const glm::vec3 &v2, Colour trigColour,bool isMirror) :
		vertices({{v0, v1, v2}}), texturePoints(), colour(std::move(trigColour)), normal(), isMirror() {}
ModelTriangle::ModelTriangle(const glm::vec3 &v0, const glm::vec3 &v1, const glm::vec3 &v2, Colour trigColour,bool isMirror,bool isGlass) :
		vertices({{v0, v1, v2}}), texturePoints(), colour(std::move(trigColour)), normal(), isMirror(),isGlass() {}
